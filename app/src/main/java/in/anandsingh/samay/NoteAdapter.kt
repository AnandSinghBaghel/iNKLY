...
class NoteAdapter : RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NoteViewHolder, position: Int) {
        ...
        val markdownContent = currentNote.content.replace("\n", "  \n")
        markwon.setMarkdown(holder.markdownView, markdownContent)
        holder.textViewDate.text =
            DateFormat.getDateTimeInstance().format(Date(currentNote.timestamp))
    }
